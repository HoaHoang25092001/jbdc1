    ...
    <div class="col">
        <form action="update.do" method="post">
            <div class="mb-3 mt-3">
                ...
                <input type="text" class="form-control" id="id" value="${toy.id}" placeholder="Enter id" name="id1" disabled="">
                <input type="hidden" class="form-control" id="id" value="${toy.id}" placeholder="Enter id" name="id" >
            </div>
            <div class="mb-3">
                <label for="name" class="form-label">Name:</label>
                <input type="text" class="form-control" id="name" value="${toy.name}" placeholder="Enter name" name="name">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" id="expDate" value="${toy.expDate}" placeholder="Enter expired date" name="expDate">
            </div>
            <div class="mb-3">
                <label for="brandId" class="form-label">Brand Id:</label>
                <input type="text" class="form-control" id="brandId" value="${toy.brandId}" placeholder="Enter Brand ID" name="brandId">
            </div>
